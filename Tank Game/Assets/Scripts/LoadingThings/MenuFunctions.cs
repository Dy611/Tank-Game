...
namespace TankGame.Menus
{
    ...
    public static class MenuFunctions
    {
        ...
        public static void SetQualityPreset(int index)
        {
        ...
        #region Project Control Methods
        /// <summary>
        /// Closes The Project
        /// </summary>
        ...
        /// <summary>
        /// Adjusts Time Scale Back To Normal
        /// </summary>
        public static void ResumeProject()
        {
            Time.timeScale = 1;
        }
        #endregion Project Control Methods
    }
}